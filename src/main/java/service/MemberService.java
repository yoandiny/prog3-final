...
public class MemberService {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            try {
                ...
                Payment payment = Payment.builder()
                        ...
                        .type(PaymentType.ADMISSION_FEE) // and annual fee combined
                        .mode(paymentMode)
                        .build();
    ...
    private void validateSponsorships(Integer targetCollectivityId, List<Sponsorship> sponsorships, Connection conn) throws SQLException {
        ...
        for (Sponsorship s : sponsorships) {
            // In a real scenario, we'd check if the sponsor is a CONFIRMED member of the federation
            // For this implementation, we check their membership to define if they belong to the target collectivity
